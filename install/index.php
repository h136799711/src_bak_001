...
$step = ($step ? $step : '1');
$installinfo = '欢迎来到 <font class="softname">' . MPS_SOFTNAME . '</font> <font class="version">' . MPS_VERSION . '</font> 安装向导，安装前请仔细阅读安装说明后才开始安装。安装文件夹里同样提供了有关软件安装的说明，请您仔细阅读。<div style="margin-top:.5em">安装过程中遇到任何问题 &nbsp;<a href="#" target="_blank" class="black"><u><b>请到官方讨论区寻求帮助</b></u></a></div>';
