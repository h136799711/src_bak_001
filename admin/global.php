...
function mymps_admin_tpl_global_foot()
{
	...
	echo '<div class="clear" style="height:10px"></div><div class="copyright">Powered by <a href="#/" target="_blank"><b style="color:#0070af">mymps</b></a> <a href="#/" target="_blank"><b style="color:#FF6600">' . MPS_VERSION . '</b></a> &copy; , ' . $sitedebug . ' <a href="javascript:scroll(0,0)" style="margin-left:10px;">至顶端↑</a></div></div></div></body></html>';
}
