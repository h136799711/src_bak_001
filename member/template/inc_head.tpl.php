    ...
    <div class="clearfix toolbar-inner">
        <div class="quicklink">
            <ul id="mymps_website_links" class="accesslink">
				<a href="../" target="_blank">返回<?php echo $mymps_global['SiteName']?>首页</a>
            </ul>
        </div>
        <div class="userbar">
...
<div class="clearfix siteportalnav">
    <ul>
        <?php if($mymps_global['head_style'] == 'new'){?><li><a href="../" target="_blank"><span><strong>网站首页</strong></span></a></li><?php }?>
